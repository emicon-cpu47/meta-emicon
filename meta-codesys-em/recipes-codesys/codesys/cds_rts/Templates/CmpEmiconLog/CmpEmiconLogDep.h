...
#define EXPORT_EXTREF_STMT \
        { (RTS_VOID_FCTPTR)write_ts_log, "write_ts_log", 0xBBC343F7, 0x03050D00 },\
          { (RTS_VOID_FCTPTR)write_ti_log, "write_ti_log", 0xEED4B686, 0x03050D00 },\
          { (RTS_VOID_FCTPTR)write_sys_log, "write_sys_log", 0xA5470BCD, 0x03050D00 },\
          { (RTS_VOID_FCTPTR)get_next_log_item, "get_next_log_item", 0xDA44E7BB, 0x03050D00 },\
          { (RTS_VOID_FCTPTR)create_log_files, "create_log_files", 0x5B82FD55, 0x03050D00 },\
          { (RTS_VOID_FCTPTR)clr_sys_log, "clr_sys_log", 0x8B141454, 0x03050D00 },\
