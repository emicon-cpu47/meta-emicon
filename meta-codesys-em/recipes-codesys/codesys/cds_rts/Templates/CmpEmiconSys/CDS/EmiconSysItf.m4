...
DEF_API(`void',`CDECL',`get_ptr_to_dpm',`(get_ptr_to_dpm_struct *p)',1,0x7C8941E2,0x03050D00)
...
DEF_API(`void',`CDECL',`get_ptr_to_slot0',`(get_ptr_to_slot0_struct *p)',1,0xE6CB94A0,0x03050D00)
...
DEF_API(`void',`CDECL',`get_ptr_to_sock_arr',`(get_ptr_to_sock_arr_struct *p)',1,0x7F4ADBA2,0x03050D00)
...
DEF_API(`void',`CDECL',`set_inhibit',`(set_inhibit_struct *p)',1,0xAFE8BB40,0x03050D00)
...
DEF_API(`void',`CDECL',`set_watchdog',`(set_watchdog_struct *p)',1,0x9CA67B6B,0x03050D00)
...
DEF_API(`void',`CDECL',`syssync',`(syssync_struct *p)',1,0xDC1119C9,0x03050D00)
