 ...
 *  </copyright>
 */
#ifndef _CMPCEDISTRIBUTEDCLOCKSDEP_H_
#define _CMPCEDISTRIBUTEDCLOCKSDEP_H_

#define COMPONENT_NAME "CmpCEDistributedClocks"COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_CmpCEDistributedClocks)
#define COMPONENT_NAME_UNQUOTED CmpCEDistributedClocks
...
#include "CmpCEDistributedClocksItf.h"
...
#ifndef CMPCEDISTRIBUTEDCLOCKS_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
          
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef CMPCEDISTRIBUTEDCLOCKS_DISABLE_EXTREF2
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry CmpCEDistributedClocks__Entry
#endif


#ifdef CPLUSPLUS

class CCmpCEDistributedClocks : public ICmpCEDistributedClocks , public ICmpEventCallback 
{
    public:
        CCmpCEDistributedClocks() : hCmpCEDistributedClocks(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CCmpCEDistributedClocks()
        {
        }
        ...
        virtual void* QueryInterface(IBase *pIBase, ITFID iid, RTS_RESULT *pResult)
        {
            void *pItf;
            if (iid == ITFID_IBase)
                pItf = dynamic_cast<IBase *>((ICmpCEDistributedClocks *)this);            
            else if (iid == ITFID_ICmpCEDistributedClocks)
                pItf = dynamic_cast<ICmpCEDistributedClocks *>(this); 
    ...
    public:
        RTS_HANDLE hCmpCEDistributedClocks;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* CmpCEDistributedClocks Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT CmpCEDistributedClocks_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF CmpCEDistributedClocks_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
